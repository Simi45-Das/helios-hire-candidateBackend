...
exports.sendEmail = async (to, userId) => {
  ...
  const mailOptions = {
    ...
    to,
    subject: "Your User Registration ID - Action Required",
    text: `Dear User,

We are pleased to inform you that your registration has been successfully completed. Below is your unique User ID, which is required to log into your account:
